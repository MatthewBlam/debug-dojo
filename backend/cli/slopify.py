...
Usage:
    python -m backend.cli.slopify --reference path/to/file.py --category bad_complexity
    python -m backend.cli.slopify --reference path/to/file.py --category wrong_condition --out slop.py
"""
